...
| **postgres** | postgres:16-alpine | rag-postgres | 5432 | 主数据库，存储应用数据 |
| **redis** | redis:7-alpine | rag-redis | 6379 | 缓存服务 |
| **ollama** | ollama/ollama:0.11.2 | rag-ollama | 11434 | 本地大语言模型服务 |
...
| 服务名 | 镜像 | 容器名 | 端口 | 作用 |
|--------|------|--------|------|------|
| **opensearch** | opensearchproject/opensearch:2.19.0 | rag-opensearch | 9200, 9600 | 向量数据库，存储论文向量嵌入 |
| **opensearch-dashboards** | opensearchproject/opensearch-dashboards:2.19.0 | rag-dashboards | 5601 | OpenSearch 可视化管理界面 |
