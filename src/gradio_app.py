...
def create_gradio_interface():
    ...
    with gr.Blocks(
        ...
        gr.Examples(
            examples=[
                ["What are transformers in machine learning?", 3, True, "qwen3.6:35b-mlx", "cs.AI, cs.LG"],
                ["How do convolutional neural networks work?", 5, True, "qwen3.6:35b-mlx", "cs.CV, cs.LG"],
                ["What is attention mechanism in deep learning?", 4, False, "qwen3.6:35b-mlx", "cs.AI"],
                ["Explain reinforcement learning algorithms", 3, True, "qwen3.6:35b-mlx", "cs.LG, cs.AI"],
                ["What are the latest developments in NLP?", 5, True, "qwen3.6:35b-mlx", "cs.CL"],
            ],
